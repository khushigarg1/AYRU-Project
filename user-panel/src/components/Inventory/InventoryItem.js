...
//           const isInWishlist = wishlistItems.some(wishlistItem => wishlistItem.inventoryId === item.id);
...
//       fetchWishlistStatus();
//     }
//   }, [token, user, item.id, isInWishlist]);
...
//       } else {
//         await api.post('/wishlist', { inventoryId: item.id, userId: user?.id }, {
//           headers: {
//             Authorization: `Bearer ${token}`
//           }
//         });
...
//         >
//           {isInWishlist ? <FavoriteOutlined style={{ color: 'red' }} /> : <FavoriteBorderOutlined />}
//         </IconButton>
//       </Box>
